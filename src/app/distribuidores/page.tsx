...
export const metadata = buildPageMetadata({
  title: "Área de distribuidores",
  description: "Acceso para distribuidores autorizados de Gautex Medica.",
  path: "/distribuidores",
  locale: "es",
  noIndex: true,
});
...
export default function DistribuidoresPage() {
  const ui = getUi("es").distributors;
