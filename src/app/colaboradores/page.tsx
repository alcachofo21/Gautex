  ...
  return (
    <div className="py-12 sm:py-16">
      <div className="container-page">
        ...
        <h2 className="mt-16 text-fluid-title font-display font-bold">Red de colaboración</h2>
        <p className="mt-2 text-text-muted">
          Comunidades autónomas, entidades sanitarias y organizaciones de prevención en toda España.
        </p>
