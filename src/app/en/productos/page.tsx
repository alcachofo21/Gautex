...
export const metadata = {
  title: "Products",
  description: "Gautex Medica product catalogue: prevention, gynaecology and COVID-19 tests.",
};
  ...
  return (
    <div className="py-12 sm:py-16">
      <div className="container-page">
        <h1 className="text-fluid-title font-display font-bold">Our products</h1>
        <p className="mt-4 max-w-2xl text-text-muted">
          Explore our three lines of CE-certified medical products for pharmacy, hospital and wholesale distribution.
        </p>
