...
import { corporate, partners } from "@/lib/products";
      ...
      <div className="container-page">
        ...
        <div className="mt-10 grid grid-cols-3 gap-4 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8">
          {partners.logos.map((logo) => (
            <div
              key={logo.name}
              className="flex aspect-square items-center justify-center rounded-xl border border-gray-100 bg-white p-3 shadow-sm"
              title={logo.name}
            >
        ...
        <div className="mt-8 text-center">
          <Link href="/colaboradores" className="text-sm font-semibold text-primary hover:underline">
